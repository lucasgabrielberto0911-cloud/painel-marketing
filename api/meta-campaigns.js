export default async function handler(req, res) {
    ...
    try {
        ...
        const url = `https://graph.facebook.com/v21.0/${formattedAccountId}/campaigns?fields=name,status,objective,daily_budget&access_token=${accessToken}`;
        ...
        return res.status(500).json({
            success: false,
            error: `Erro interno no servidor ao buscar campanhas: ${err.message}`
        });
    }
}
